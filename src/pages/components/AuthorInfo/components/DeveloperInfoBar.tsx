...
const DeveloperInfoBar = () => {
  ...
  return (
    <motion.div
      ...
      className="rounded-tl-[14px] md:rounded-tr-[2px] rounded-tr-[14px] md:rounded-b-[2px] rounded-b-[14px] md:w-[50%] w-full md:h-[310px] sm:h-[220px] border border-[#424040aa] bg-[#141414] sm:p-5 p-6"
    >
      <div className="text-[#fffffff6] h-[70%] w-full sm:pl-4">
        <h1 className="lg:text-4xl sm:text-3xl text-2xl lg:mt-4 sm:mt-1">{data.developerBar.title}</h1>
        <p className="lg:text-xl sm:text-lg sm:mt-2 lg:w-[80%] sm:w-[90%] w-[98%] text-[#a9a9a9]">
