...
const AuthorMainInfoBar = () => {
    ...
    return (
        <motion.div
            ...
            className="bg-[#141414] border border-[#424040aa] rounded-b-[14px] md:rounded-t-[2px] rounded-t-[14px] backdrop-opacity-50 mx-auto sm:w-[98.6%] w-[96%] flex md:flex-row flex-col justify-between items-center sm:px-5 px-3 py-6"
        >
            {/* AUTHOR INFO BAR */}
